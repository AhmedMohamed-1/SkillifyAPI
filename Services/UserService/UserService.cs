...
namespace SkillifyAPI.Services.UserService
{
    public class UserService : IUserService
    {
        ...
        public async Task<SkillifyAPI.DTOs.PagedResult<UsersListDTO>> GetUsersAsync(int page, int pageSize, string? name = null, int? skillId = null, decimal? minRating = null, int? langId = null, int? currentUserId = null, CancellationToken ct = default)
        {
            var (users, totalCount) = await _repo.GetUsersPagedAsync(page, pageSize, name, skillId, minRating, langId, currentUserId, ct);
